<?php
/**
 * Plugin Name: Open Badge Factory Community Add-On
 * Plugin URI: http://www.badgeos.org/
 * Description: This Open Badge Factory add-on integrates Open Badge Factory features with BuddyPress and bbPress.
 * Tags: buddypress
 * Author: Credly
 * Version: 1.2.1
...
class BadgeOS_Community extends Obf_SubmoduleBase {
	...
	public $directory_url = '';
        ...
        /**
	 * Open Badge Factory BuddyPress Triggers
	 *
	 * @var array
	 */
	public $community_triggers = array();
