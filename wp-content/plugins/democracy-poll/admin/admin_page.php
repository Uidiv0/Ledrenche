	...
	<div class="democr_options dempage_settings">
		<form action="" method="POST">
			...
			<ul style="margin:1em;">
				...
				<li class="block">
				   <label>
					   <input type="text" size="3" value="<?php echo intval($opt['cookie_days']) ?>" name="dem[cookie_days]" />
					   <?php _e('How many days to keep Cookies alive?','democracy-poll') ?>
					</label>
				   <em><?php _e('How many days the user\'s browser remembers the votes. Default: 365. <strong>Note:</strong> works together with IP log.','democracy-poll') ?></em>
				</li>
