...
Class Responsive_Pro_Options extends Responsive_Options {
	...
	protected function upload( $args ) {
		...
		$html = '<div class="grid col-700 media-upload">
                    <input id="responsive_theme_options_' . $id . '" name="responsive_theme_options[' . $id . ']" type="text" value="' . esc_attr( $value ) . '" />
                    <label class="description" for="responsive_theme_options[' . $id . ']">' . $description . '</label>
                    <button class="button upload" name="responsive_theme_options[' . $id . ']_upload" id="responsive_theme_options_' . $id . '_upload">' . $button . '</button>
                    </div>
