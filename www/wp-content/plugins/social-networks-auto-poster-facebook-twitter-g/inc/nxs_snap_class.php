...
- Super Admin can also manage/setup/disable/override SNAP settings for each Blog/Site.<br/>
               ...
               <br/>
                <br/><br/>
if you already got "SNAP Pro for Wordpress Multisite" please click here to <img id="checkAPI2xLoadingImg" style="display: none;" src="http://nvrn.net/wp-content/plugins/social-networks-auto-poster-facebook-twitter-g/img/ajax-loader-sm.gif"><a href="" id="checkAPI2x">[Update the API] </a> or <a href="" id="showLic2x">[Change Activation Key]</a>
               <?php return; 
          }
        }
        ...
        function showSNAutoPosterOptionsPage() { global $nxs_snapAvNts, $nxs_snapThisPageUrl, $nxsOne, $nxs_plurl, $nxs_isWPMU, $nxs_tpWMPU; $cst=strrev('enifed'); $nxsOne = ''; $options = $this->nxs_options; $trrd=0;
          ...
          if (isset($_POST['nxsMainFromElementAccts']) || isset($_POST['nxsMainFromSupportFld'])) { check_ajax_referer('nxsSsPageWPN'); wp_cache_flush();
            ...
            if (isset($_POST['ogAuthorFB']))    $options['ogAuthorFB'] = $_POST['ogAuthorFB'];  
            ...
            if (isset($_POST['nxsOG']))   $options['nxsOG'] = $_POST['nxsOG']; else $options['nxsOG'] = 'N';
...
<input name="riHowManyPostsToTrack" style="width: 50px;" value="<?php if (isset($options['riHowManyPostsToTrack'])) _e(apply_filters('format_to_edit', $options['riHowManyPostsToTrack']), 'social-networks-auto-poster-facebook-twitter-g'); else echo "10"; ?>" /> <br/>
     ...
     <!-- ##################### Open Graph #####################-->
             ...
             <div class="nxs_box_inside"> <span style="font-size: 11px; margin-left: 1px;"><?php _e('SNAP has a very simple implementation of the "Open Graph" metatags. Please see here for more info - SNAP Open Graph Tags', 'social-networks-auto-poster-facebook-twitter-g') ?> </span> <br/>              
              <div class="itemDiv"> <?php  $ogMsgT =  __('plugin has been detected', 'social-networks-auto-poster-facebook-twitter-g').' '.__('It has support for OG Metatags. Please disable SNAP OG Tags to avoid conflicts.', 'social-networks-auto-poster-facebook-twitter-g'); $ogMsg = '';
...
<?php } elseif(defined('NextScripts_UPG_SNAP_Version')) { ?> <br/><span style="color:red;">You have "SNAP Upgrade helper" installed, now please&nbsp;<a href="#" id="showLic2x">[Enter Activation Key]</a></span><br/><br/> <?php } ?>
<?php nxs_memCheck(); ?><br/>
